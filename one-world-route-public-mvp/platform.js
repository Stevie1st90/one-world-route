(() => {
  ...
  function updateTimelineRegional(){
    ...
    const meta=$('#regionalTimelineMeta');if(meta)meta.textContent=`${t('segments')} ${s.sequence} / ${currentTrip.segments.length} · ${String(s.transport?.mode||'').replaceAll('-',' ')}`;
