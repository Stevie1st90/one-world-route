...
(() => {
  ...
  function renderTripOverview(){
    ...
    d.tripTools.bind({host:content,trip,meta,profile,storage:d.storage,t:d.t,local:d.local,facetLabel:d.facetLabel,planningSnapshot,locale:d.locale(),toast:d.toast});
  }
