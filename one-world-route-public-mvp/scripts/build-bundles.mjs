...
const groups=[
  ...
  {out:'features.bundle.js',files:['operational-movements.js','iteration6.js','iteration7.js','iteration8.js','platform/runtime.js','platform/map-style.js','iteration9.js','iteration10.js','release2.js','platform/i18n.js','platform/legacy-localization.js','platform/model.js','platform/traveller.js','platform/traveller-ui.js','platform/ui.js','platform/navigation.js','platform/discovery.js','platform/route-library.js','platform/story.js','platform/terrain.js','platform/extensions.js','platform.js'],prefix:'/* ONE WORLD ROUTE feature runtime bundle. */\n'},
