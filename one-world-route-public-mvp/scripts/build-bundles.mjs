...
const groups=[
  ...
  {out:'features.bundle.js',files:['iteration6.js','iteration7.js','iteration8.js','iteration9.js','iteration10.js','release2.js'],prefix:'/* ONE WORLD ROUTE feature runtime bundle. */\n'},
