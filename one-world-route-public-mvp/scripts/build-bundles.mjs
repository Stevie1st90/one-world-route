...
const groups=[
  ...
  {out:'features.bundle.js',files:['operational-movements.js','iteration6.js','iteration7.js','iteration8.js','iteration9.js','iteration10.js','release2.js'],prefix:'/* ONE WORLD ROUTE feature runtime bundle. */\n'},
  {out:'core.bundle.css',files:['styles.css','iteration2.css','iteration5.css','story.css'],prefix:'/* ONE WORLD ROUTE core styles bundle. */\n'},
  {out:'features.bundle.css',files:['iteration6.css','iteration7.css','release2.css'],prefix:'/* ONE WORLD ROUTE feature styles bundle. */\n'}
];
