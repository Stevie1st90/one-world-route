...
await writeFile(new URL('../data/flight-geometries.json',import.meta.url),JSON.stringify({version:1,method:'Airport coordinates only; no assertion of airline service, schedule or booking availability.',geometries,review},null,2)+'\n');
