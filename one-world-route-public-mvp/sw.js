const CACHE='one-world-route-italy-sourced-v1-20260921a';
const CORE=['/','/index.html','/core.bundle.css','/features.bundle.css','/core.bundle.js','/features.bundle.js','/manifest.webmanifest','/icon.svg','/data/public-route.json','/data/country-centroids.json','/data/route-waypoints.json','/data/flight-geometries.json','/data/operational-movements.json','/data/platform/trips.json','/data/platform/trips/italy-grand-tour.json','/data/platform/trip-schema.json','/data/platform/traveller-context-schema.json','/data/platform/traveller-rule-schema.json'];
